...
export default function userDeviceInfo(id){
    ...
    if(isMobile.ios()){
        $id.innerHTML += `<p><mark>Este contenido solo se ve en Iphone</mark></p>`;
    }
    if(isDesktop.mac()){
    ...
    //con el window.location.href podemos redireccionar automaticamente al usuario hacia el sitio que nosotros queramos.
    if(isMobile.ios()){
        window.location.href = "https://youtu.be/wklZCUECKU8"
    }
}